 ...
 *
 */
@Component(BitstreamIIIFV3VirtualMetadata.IIIF_BITSTREAM_VIRTUAL_METADATA_BEAN_PREFIX + "V3" + "format")
public class BitstreamFormatIIIFVirtualMetadata implements BitstreamIIIFV3VirtualMetadata {
